<script>
    ...
    const purple = '<span style="color: var(--purple);">';
    ...
    const CONTENT = `
        ...
        ${ul}
        ${li}Tap a  ${blue}blue</span> or ${gold}yellow</span> tile to rotate its cluster.</li>
        ${li}The tapped tile shifts into the ${purple}purple</span> group.</li>
